...
def GetKp(Date=None):
        ...
        Retrieves Kp data from memory, or from file if it hasn't been loaded
yet.

        Args:
            Date (int or tuple): Integer date in the format yyyymmdd,
                or a two-element tuple of integers for loading a range of dates.

        Returns:
            numpy.recarray: Kp data corresponding to the specified date or date
range.
